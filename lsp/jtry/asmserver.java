...
public class asmLanguageServer implements LanguageServer, LanguageClientAware {

    private static final Logger logger = LoggerFactory.getLogger(asmLanguageServer.class);
    ...
    public CompletableFuture<InitializeResult> initialize(InitializeParams params) {
        logger.debug("Initializing asm Language Server");
        ...
        asmWorkspaceCompiler compiler =
                asmWorkspaceCompiler.of(targetDirectory, workspaceRoot, changedFilesDirectory);
        TreeParser parser =
                asmTreeParser.of(compiler, workspaceRoot,
                        new WorkspaceUriSupplier(workspaceRoot, changedFilesDirectory));
        DefaultCompilerWrapper asmcWrapper = new DefaultCompilerWrapper(compiler, parser);
        state.setCompilerWrapper(asmcWrapper);
